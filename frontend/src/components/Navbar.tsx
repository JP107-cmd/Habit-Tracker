...
export default function Navbar() {
    ...
    return(
        <div className="sticky top-0 z-10 w-full px-6 py-4 flex items-center justify-between bg-[#1a1a1a]/90 backdrop-blur border-b border-white/10">
            ...
            <div>
                <button
                    onClick={logout} className="px-4 py-2 text-sm font-medium rounded-lg bg-white/5 text-neutral-300 border border-white/10 hover:bg-white/10 hover:text-white transition-colors ">
                    Log out
                </button>
            </div>
        </div>
